    ...
    <div className="min-h-dvh bg-bg flex flex-col items-center justify-center px-6">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-bold leading-tight">Content de te revoir</h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-violet-500 text-white font-bold rounded-xl active:bg-violet-600 transition-colors disabled:opacity-50 text-sm"
          >
