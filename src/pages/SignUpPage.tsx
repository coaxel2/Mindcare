    ...
    <div className="min-h-dvh bg-bg flex flex-col items-center justify-center px-6">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label className="text-sm font-medium text-text-secondary mb-1.5 block">Prénom</label>
          ...
          <div>
            <label className="text-sm font-medium text-text-secondary mb-1.5 block">Confirmer le mot de passe</label>
            <div className="relative">
              <Lock size={18} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-text-muted" />
              <input
                type={showPassword ? 'text' : 'password'}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 bg-violet-500 text-white font-semibold rounded-full hover:bg-violet-600 transition-colors disabled:opacity-50 mt-2"
          >
